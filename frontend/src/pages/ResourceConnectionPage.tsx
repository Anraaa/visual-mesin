...
const allResources = [
  ...
  { value: 'rsc-pc1', label: 'rsc-pc1' },
  { value: 'rtltl1', label: 'rtltl1' },
  { value: 'bpbl', label: 'bpbl' },
  { label: 'Curing', group: true },
  { value: 'curtire', label: 'curtire' },
  { value: 'rtci1', label: 'rtci1' },
  { value: 'rtctr1', label: 'rtctr1' },
  { value: 'gtentire', label: 'gtentire' },
  ...
  { value: 'recipe_material', label: 'recipe_material' },
  ...
  { value: 'rtc-tr1', label: 'rtc-tr1' },
  { value: 'rtl-tl1', label: 'rtl-tl1' },
